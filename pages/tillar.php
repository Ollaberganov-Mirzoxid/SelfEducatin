...
<body>
    ...
    <div class="mobile_nav">
        ...
        <a class="activee" href="tillar.php"><i class="fas fa-language"></i><span>Chet tillar</span></a>
    ...
    <div class="content">
        <div class="header2">
            <div class="menu">
                <a href="maktab.php"><h3 class="activee">Turk Tili</h3></a>
        ...
        <div class="body">
            <div class="full">
                <video src="../video/Turk/5.mp4"controls></video>
                <p>3-DARS. 1-QISM KISHILIK OLMOSHLARI</p>
            </div>
            <div class="full">
                <video src="../video/Turk/6.mp4"controls></video>
                <p>3-DARS. 2-QISM KISHILIK OLMOSHLARI</p>
            </div>
            <div class="full">
                <video src="../video/Turk/7.mp4"controls></video>
                <p>3-DARS. 3-QISM KISHILIK OLMOSHLARI</p>
            </div>
            <div class="full">
                <video src="../video/Turk/8.mp4"controls></video>
                <p>4-DARS ENG KO'P ISHLATILADIGAN IBORALAR</p>
            </div>
        </div>
    </div>
    </div>
