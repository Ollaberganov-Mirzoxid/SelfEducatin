...
<body>
    ...
    <div class="mobile_nav">
        ...
        <a href="OTM.php"><i class="fa-solid fa-graduation-cap"></i><span>OTM</span></a>
        ...
        <a class="activee" href="../workpages/learning_center"><i class="fas fa-chalkboard-user"></i><span>O'quv Markazlar</span></a>
    </div>
    </div>
