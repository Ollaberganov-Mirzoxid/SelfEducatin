...
<body>
    ...
    <div class="mobile_nav">
        ...
        <a href="#"><i class="fa-solid fa-graduation-cap"></i><span>OTM</span></a>
    ...
    <div class="content">
        ...
        <div class="header2">
            <div class="menu">
                <a href="maktab.php"><h3 class="sinflar">Matematika</h3></a>
                ...
                <a class="book" href="workpages/kitoblar.php"><h3 class="activee" >Kitoblar</h3></a>
        </div>
    </div>
    <style>
        .content1{
